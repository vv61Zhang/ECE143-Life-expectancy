...
Cause we have 18-dimensional variable now, it is simply waste of time to deal with all of them. Thus we should detect the data internally to find our principle components, which involves PCA(Principle component analysis).
